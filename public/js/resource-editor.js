    ...
    function createEditor(options) {
        ...
        function build() {
            ...
            if (!doc.getElementById('edulock-resource-styles')) {
                ...
                style.textContent = `
                    .er-dialog{width:min(780px,calc(100vw - 24px));max-height:92vh;margin:auto;border:1px solid var(--c-border,#e4dfdd);border-radius:12px;padding:22px;background:var(--c-surface,#ffffff);color:var(--c-text,#141010);font:14px 'Segoe UI',sans-serif;overflow:auto}
                    .er-dialog::backdrop{background:rgba(20,16,16,.35)}
                    .er-dialog *{box-sizing:border-box}.er-dialog [hidden]{display:none!important}
                    .er-heading,.er-actions,.er-row{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.er-heading{justify-content:space-between}.er-heading h2{font-size:1.2rem;margin:0}.er-dialog p{margin:8px 0;line-height:1.5}.er-muted{color:var(--c-muted,#6d635d);font-size:.83rem}
                    .er-button{padding:9px 13px;border:1px solid transparent;border-radius:6px;background:var(--c-primary,#d81f2a);color:#fff;cursor:pointer;font:inherit;line-height:1.2}.er-secondary{background:transparent;border-color:var(--c-border,#d6cfcb);color:inherit}.er-button:disabled{opacity:.55;cursor:wait}.er-dialog :focus-visible{outline:2px solid #d81f2a;outline-offset:3px}
                    .er-fieldset{border:1px solid var(--c-border,#e4dfdd);border-radius:8px;padding:14px;margin-top:14px;min-width:0}.er-fieldset legend{padding:0 6px;font-weight:600}.er-field{display:grid;gap:5px;margin-bottom:12px}.er-field label{font-size:.85rem;color:inherit}.er-dialog input:not([type=checkbox]),.er-dialog select{width:100%;padding:9px;background:var(--c-surface2,#f7f5f4);border:1px solid var(--c-border,#d6cfcb);border-radius:6px;color:inherit;font:inherit}.er-columns{display:grid;grid-template-columns:1fr 1fr;gap:12px}.er-list{display:grid;gap:9px;margin:12px 0}.er-resource{border:1px solid var(--c-border,#e4dfdd);border-radius:8px;padding:12px;overflow-wrap:anywhere}.er-resource strong{font-size:.92rem}.er-resource a{color:#a1121b;text-decoration:underline}.er-resource .er-actions{margin-top:9px}.er-status{min-height:24px;white-space:pre-wrap;margin:12px 0;color:var(--c-success,#157347)}.er-error{color:var(--c-error,#c41f28)}.er-warning{padding:10px;border:1px solid #eddcba;background:#fdf3e3;border-radius:6px;color:#8a5a00;margin-bottom:12px;line-height:1.45}.er-warning label{display:flex;gap:8px;align-items:flex-start;margin-top:8px;color:inherit}.er-warning input{width:auto!important;margin-top:3px;flex:0 0 auto}.er-delete{border:1px solid #f3c5c7;border-radius:7px;padding:12px;margin-top:12px}.er-legacy{margin:14px 0;border-top:1px solid var(--c-border,#e4dfdd);padding-top:10px}.er-legacy summary{cursor:pointer;padding:5px 0}
